            ...
            <section className="mb-6">
              ...
              <div className="mb-4 bg-indigo-50 p-3 rounded-lg">
                ...
                <div className="pl-3 border-l-4 border-indigo-300 mb-2">
                  <p className="mb-1"><span className="font-semibold">Algorithm Steps:</span></p>
                  <ol className="list-decimal ml-5 mb-3 text-sm">
                    <li>Create a 2D table with items as rows and weights from 0 to capacity as columns</li>
                    <li>Fill the first row and column with zeros (base case)</li>
                    <li>For each item and each weight capacity:</li>
                    <ul className="list-disc ml-5 mb-1">
                      <li>If the item's weight exceeds current capacity, use the value from excluding this item</li>
                      <li>Otherwise, take the maximum of including vs excluding the item</li>
                    </ul>
                    <li>The bottom-right cell contains the maximum achievable value</li>
                    <li>Backtrack through the table to determine which items were selected</li>
                  </ol>
                  <p className="mb-1 text-sm"><span className="font-semibold">Time Complexity:</span> O(n × W) where n is the number of items and W is the capacity</p>
              ...
              <div className="bg-indigo-50 p-3 rounded-lg">
                ...
                <div className="pl-3 border-l-4 border-indigo-300 mb-2">
                  ...
                  <ol className="list-decimal ml-5 mb-3 text-sm">
                    ...
                    <li>Sort all items by value-to-weight ratio in descending order</li>
                    <li>Initialize result value to 0 and remaining capacity to W</li>
                    <li>For each item in the sorted order:</li>
                    <ul className="list-disc ml-5 mb-1">
                      <li>If the entire item fits, take it all and update remaining capacity</li>
                      <li>Otherwise, take a fraction of the item that fits in remaining capacity</li>
                    </ul>
                  </ol>
                  <p className="mb-1 text-sm"><span className="font-semibold">Time Complexity:</span> O(n log n) due to sorting</p>
                  <p className="text-sm"><span className="font-semibold">Space Complexity:</span> O(n)</p>
                </div>
              </div>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-indigo-50 p-3 rounded-lg">
                  ...
                  <ul className="list-disc ml-5 mb-1 text-sm">
                    <li><span className="font-semibold">Add Items:</span> Set value and weight for each item</li>
                    <li><span className="font-semibold">Knapsack Capacity:</span> Set the maximum weight</li>
                ...
                <div className="bg-indigo-50 p-3 rounded-lg">
                  ...
                  <ul className="list-disc ml-5 mb-1 text-sm">
                    <li><span className="font-semibold">Play/Pause:</span> Start/stop the simulation</li>
                    <li><span className="font-semibold">Step:</span> Advance one step at a time</li>
                    <li><span className="font-semibold">Reset:</span> Return to initial state</li>
                ...
                <div className="bg-indigo-50 p-3 rounded-lg md:col-span-2">
                  ...
                  <ul className="list-disc ml-5 mb-1 text-sm">
                    <li><span className="font-semibold">DP Table:</span> Shows the dynamic programming solution for 0/1 knapsack</li>
                    <li><span className="font-semibold">Greedy Table:</span> Shows items sorted by value/weight ratio for fractional knapsack</li>
                    <li><span className="font-semibold">Knapsack:</span> Visually represents items added to the knapsack with animations</li>
                    <li><span className="font-semibold">Summary:</span> Shows the final total value and weight information</li>
                    <li><span className="font-semibold">Tooltips:</span> Hover over cells and items for detailed information</li>
                  </ul>
                </div>
              </div>
            </section>
